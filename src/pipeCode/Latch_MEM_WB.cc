...
{ m_mdr_new = mdr; }
void Latch_MEM_WB::push_aluout(const int32_t& aluout)
{ m_aluout_new = aluout; }
void Latch_MEM_WB::push_opB(const int32_t& opB)
{ m_opB_new = opB; }
...
{ return m_mdr_old; }
int32_t Latch_MEM_WB::pull_aluout() const
{ return m_aluout_old; }
int32_t Latch_MEM_WB::pull_opB() const
{ return m_opB_old; }
