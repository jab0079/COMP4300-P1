...
Inst_BGE::Inst_BGE(ScoreboardSimulator* simu, inst the_instruction)
...
void Inst_BGE::memory()
{
    //blank for bge
}

void Inst_BGE::write_back()
{
    //blank for bge
}
