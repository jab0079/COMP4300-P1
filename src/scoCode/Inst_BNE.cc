...
Inst_BNE::Inst_BNE(ScoreboardSimulator* simu, inst the_instruction)
...
void Inst_BNE::memory()
{
    //blank for bne
}

void Inst_BNE::write_back()
{
    //blank for bne
}
